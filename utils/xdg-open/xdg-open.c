...
int main(int argc, char *argv[])
{
    ...
    if (g_str_has_prefix(url, "file:///")) {
        ...
        if (!g_spawn_command_line_async(
                "qmlscene /opt/click.ubuntu.com/rocketchat.pparent/current/utils/download-helper/qml/ExportPage.qml -I /opt/click.ubuntu.com/rocketchat.pparent/current/utils/download-helper/",
                &error)) {
