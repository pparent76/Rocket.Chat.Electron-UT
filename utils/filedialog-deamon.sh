...
utils/rm.sh -rvf /home/phablet/.cache/rocketchat.pparent/downloads/*
allreadynavigated=0
    ...
    if [ "$needtoexport" -ne "0" ]; then
                ...
                if [ "$?" -eq "1" ]; then
                    ...
                    if [ "$lock" != "lock" ]; then
                       ...
                       ( qmlscene utils/download-helper/qml/ExportPage.qml -I  utils/download-helper/; echo "" >/home/phablet/.cache/rocketchat.pparent/exportlock)  &
                       xdotool sleep 5;
                       echo "">/home/phablet/.cache/rocketchat.pparent/downloads/00000000.png
                       utils/rm.sh /home/phablet/.local/share/rocketchat.pparent/recently-used.xbel
                    fi
